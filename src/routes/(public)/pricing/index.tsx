      ...
      <Section>
        <Container>
          ...
          <p class="mt-12 text-center text-sm text-slate-600 dark:text-slate-400">
            ...
            <Link href={MARKETING_ROUTES.contact} class="font-medium text-primary-600 hover:text-primary-700 dark:text-primary-400">
...
export const head: DocumentHead = () => {
  ...
  return {
    ...
    links: [{ rel: 'canonical', href: `${baseUrl}/pricing` }],
  };
};
