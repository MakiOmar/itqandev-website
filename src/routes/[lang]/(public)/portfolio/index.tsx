...
export const usePortfolioCmsPage = routeLoader$(async ({ request, params }) => {
...
/** Legacy hard-coded layout when CMS page slug `portfolio` is missing or pages module is off. */
const LegacyPortfolioFallback = component$(() => {
...
export const head: DocumentHead = ({ resolveValue, url }) => {
  ...
  try {
    const page = resolveValue(usePortfolioCmsPage) as PublicPageDetail | null;
