...
export const useArchivesList = routeLoader$(async ({ cookie, request, params }) => {
  try {
    const api = adminApiClient(cookie, request, params.lang);
    const res = await api.get(API_ENDPOINTS.APPEARANCE.ARCHIVES);
...
export default component$(() => {
  ...
  return <ChromeLayoutListPage kind="archive" initialItems={list.value} />;
});

export const head: DocumentHead = { title: 'Archive templates' };
