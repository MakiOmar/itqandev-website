...
export const useArchiveLayout = routeLoader$(async ({ params, cookie, request, fail }) => {
  if (params.id === 'new') {
  ...
  try {
    ...
    const res = await api.get(API_ENDPOINTS.APPEARANCE.ARCHIVE_GET(id));
...
export default component$(() => {
  ...
  return <ChromeLayoutEditPage kind="archive" layout={layout.value as ChromeLayoutMeta} />;
});

export const head: DocumentHead = { title: 'Edit archive template' };
