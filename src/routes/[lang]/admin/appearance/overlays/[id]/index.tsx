...
export const useOverlayLayout = routeLoader$(async ({ params, cookie, request, fail }) => {
  if (params.id === 'new') {
  ...
  try {
    ...
    const res = await api.get(API_ENDPOINTS.APPEARANCE.OVERLAY_GET(id));
...
export default component$(() => {
  ...
  return <ChromeLayoutEditPage kind="overlay" layout={layout.value as ChromeLayoutMeta} />;
});

export const head: DocumentHead = { title: 'Edit overlay' };
