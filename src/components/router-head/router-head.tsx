...
import { collectPreconnectHints } from "~/lib/perf/resource-hints";
...
export const RouterHead = component$(() => {
  ...
  const preconnectHints = collectPreconnectHints(loc.url.origin);
  ...
  return (
    <>
      ...
      {preconnectHints.map((hint) => (
        <link
          key={`${hint.href}${hint.crossOrigin ? "-cors" : ""}`}
          rel="preconnect"
          href={hint.href}
