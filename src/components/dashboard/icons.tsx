 ...
 * Each icon has proper background styling
 */
...
export const NotificationsIcon = component$(() => (
  <svg
    class="h-6 w-6"
    fill="none"
    stroke="currentColor"
...
export const SystemHealthIcon = component$(() => (
  <svg
    class="h-6 w-6"
    fill="none"
    stroke="currentColor"
...
/**
 * Additional SVG icons for dashboard statistics and activities
 */

export const UsersGroupIcon = component$(() => (
  <svg
    class="h-6 w-6"
    fill="none"
    stroke="currentColor"
...
export const CurrencyDollarIcon = component$(() => (
  <svg
    class="h-6 w-6"
    fill="none"
    stroke="currentColor"
...
export const CategoriesIcon = component$(() => (
  <svg
    class="h-6 w-6"
    fill="none"
    stroke="currentColor"
...
/** Sidebar: marketing services */
export const ServicesIcon = component$(() => (
  <svg
    class="h-6 w-6"
    fill="none"
    stroke="currentColor"
...
export const TestimonialsIcon = component$(() => (
  <svg
    class="h-6 w-6"
    fill="none"
    stroke="currentColor"
...
export const BlogIcon = component$(() => (
  <svg
    class="h-6 w-6"
    fill="none"
    stroke="currentColor"
...
export const MediaIcon = component$(() => (
  <svg
    class="h-6 w-6"
    fill="none"
    stroke="currentColor"
