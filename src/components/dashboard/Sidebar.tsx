...
export const Sidebar = component$<SidebarProps>((props) => {
  ...
  const navItems: NavItem[] = [
    ...
    },
    {
      ...
      icon: SettingsIcon,
      children: [
        { label: translateApp(lang, 'sidebar.appearanceThemeBuilder'), href: R.ADMIN.APPEARANCE_THEME_BUILDER },
        ...
        { label: translateApp(lang, 'sidebar.appearanceBody'), href: R.ADMIN.APPEARANCE_BODY },
        { label: translateApp(lang, 'sidebar.appearanceSingles'), href: R.ADMIN.APPEARANCE_SINGLES },
        { label: translateApp(lang, 'sidebar.appearanceArchives'), href: R.ADMIN.APPEARANCE_ARCHIVES },
